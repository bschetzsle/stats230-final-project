...
In otherwords, given a proposed value of $\bm{\theta}$, generate $n$ iid datasets from the distribution that hypothetically also generated the observed data $\bm{Y}$.
